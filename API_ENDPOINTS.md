# ChainSight API Endpoints Documentation

Base URL: `https://api.ChainSight.com/api/v1`
...
```javascript
// Connection
const ws = new WebSocket('wss://api.ChainSight.com/ws?token={jwt_token}');
...
7. **CORS**: Configure for frontend domain `https://ChainSight.com`
